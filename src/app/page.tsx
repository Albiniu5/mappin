    ...
    const fetchConflicts = async () => {
      ...
      if (data) {
        ...
        if (conflicts.length > 0) {
          ...
          setCurrentDate(maxDate) // Set to most recent
        }
      }
  ...
  useEffect(() => {
    const triggerFeedRefresh = async () => {
      try {
        ...
        // Refetch conflicts if new data was added
    ...
    // Trigger after initial load completes
    const timer = setTimeout(triggerFeedRefresh, 2000)
